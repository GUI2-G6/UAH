...
For architecture and runtime details, see [uah-browser-extension/README.md](https://github.com/GUI2-G6/UAH/blob/dev/uah-browser-extension/README.md).

## Prerequisites

- Node.js: `^20.19.0 || >=22.12.0` (see [package.json](https://github.com/GUI2-G6/UAH/blob/dev/uah-browser-extension/package.json)).
