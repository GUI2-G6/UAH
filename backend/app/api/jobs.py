...
def search_jobs(
    ...
    provider: str | None = Query(None, description="Optional provider slug filter."),
    location_country_code: str | None = Query(None, min_length=2, max_length=2, description="Optional normalized country code filter."),
