...
class Settings:
    ...
    JOB_DEDUP_BACKFILL_BATCH_SIZE: int = int(os.getenv("JOB_DEDUP_BACKFILL_BATCH_SIZE", "100"))
    JOB_DEDUP_BACKFILL_INTERVAL_SECONDS: int = int(os.getenv("JOB_DEDUP_BACKFILL_INTERVAL_SECONDS", "1800"))
